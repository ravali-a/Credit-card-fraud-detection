...
query = '''WITH t1 AS (SELECT cc_num, amt, trans_date_trans_time FROM `extreme-lore-352210.cc_data.train_raw`
UNION ALL 
SELECT cc_num, amt, trans_date_trans_time FROM `extreme-lore-352210.cc_data.test_raw`),
